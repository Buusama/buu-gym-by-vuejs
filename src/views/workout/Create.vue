<template>
  <div class="intro-y flex items-center mt-8">
    <h2 class="text-lg font-medium mr-auto">Thêm mới bài tập</h2>
  </div>
  <div class="grid">
              ...
              <div class="grid grid-cols-12 gap-x-5">
                <div class="col-span-12 2xl:col-span-6">
                  <div>
                    ...
                    <input v-model="nameRoom" type="text" class="form-control" placeholder="Tên bài tập" />
                  </div>
...
const createWorkoutFunc = async () => {
  ...
  if (res) {
    showMessage("Thêm mới bài tập thành công", true);
