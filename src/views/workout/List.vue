<template>
  <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
    <h2 class="text-lg font-medium mr-auto">Danh sách bài tập</h2>

    <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
      <router-link :to="{ name: 'create-workout' }" class="btn btn-primary shadow-md mr-2">
        Thêm mới bài tập
      </router-link>
    </div>
  </div>
      ...
      <ModalBody>
        <div class="p-5 text-center">
          ...
          <div class="text-gray-600 mt-2">
            Bạn có chắc muốn xóa bài tập này không? <br />Thay tác này sẽ không thể hoàn
            tác
          </div>
        </div>
        ...
        formatter(cell) {
          return `
            <div class="flex items-center lg:justify-center">
              <div class="intro-x">
                <div class="font-medium whitespace-nowrap">${cell.getData().id}</div>
              </div>
            </div>`;
        },
      },
      ...
      },
       {
        ...
        formatter(cell) {
          return `
            <div class="flex items-center lg:justify-center">
              <div class="intro-x">
                <div class="font-medium whitespace-nowrap">${cell.getData().description}</div>
              </div>
            </div>`;
        },
      },
