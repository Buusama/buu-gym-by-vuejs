...
const getMemberData = async () => {
  ...
  name.value = res.data.MemberName
  gender.value = res.data.MemberGender
  phone.value = res.data.MemberPhone
  email.value = res.data.MemberEmail
  address.value = res.data.MemberAddress
  date.value = res.data.MemberBirthDate
